/**
 * Reference
 * https://introcs.cs.princeton.edu/java/22library/Gaussian.java.html//References
 * 
 * @author Anurup Borah
 */
package com.math.bodmas.mathlogic;
...
public class Gaussian{
    ...
    // bisection search
    public double inverseCDF(double y, double delta, double lo, double hi) {
